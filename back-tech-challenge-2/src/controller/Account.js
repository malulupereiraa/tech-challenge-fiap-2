...
class AccountController {
  ...
  async updateTransaction(req, res) {
    ...
    const transactionDTOFormatted = {...transactionDTO, id: transactionId}
    const transaction = await saveTransaction({ transaction: transactionDTOFormatted, repository: transactionRepository })
